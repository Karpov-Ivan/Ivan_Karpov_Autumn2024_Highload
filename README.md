...
| Linkerd        | Сервисная mesh-сеть                      | Инструмент для организации mesh-сети, который улучшает мониторинг и безопасность связи между микросервисами. Поддерживает балансировку нагрузки и автоматическое шифрование трафика между сервисами. |
