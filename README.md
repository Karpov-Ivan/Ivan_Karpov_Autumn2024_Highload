...
Product_Stats, Product_Rating, Comment_Stats, Product_Event_, Company_Event_, Comment_Event_, Product_Rating_Event_, Profile_Activity, Profile_Features, Product_Features | ClickHouse | ClickHouse - колоночная база данных, предназначенная для быстрого чтения и анализа больших объемов данных. ClickHouse отличается высокой производительностью при чтении, особенно при агрегации данных. ClickHouse оптимизирован для быстрой вставки больших объемов данных. Он использует механизм "append-only", где новые данные добавляются в конец таблицы, что ускоряет процесс. 
